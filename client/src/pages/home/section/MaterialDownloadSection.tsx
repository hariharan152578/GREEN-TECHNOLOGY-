...
// import { FiDownload, FiEye, FiFileText, FiBookOpen, FiFilm, FiFolder } from 'react-icons/fi';
...
// // --- 2. Sample Data (Updated without isPremium) ---
...
// // --- 4. Material Card Component (ENHANCED - Bigger and Cleaner) ---
...
//   const handlePreview = () => {
//     alert(`Previewing: ${material.fileName} (In a real app, this would open a modal/new tab)`);
//   };
...
//         
//         {/* Description */}
//         <p className="text-base mb-4 leading-relaxed h-16 overflow-hidden" style={{ color: darkGreen, opacity: 0.7 }}>
...
//           className="w-full flex items-center justify-center space-x-3 px-6 py-3 text-lg font-bold rounded-xl shadow-lg transition-colors"
...
// // --- 5. Main Material Download Section Component ---
...
//           style={{ color: cream }}
//         >
//           Resource<span style={{ color: gold }}>.</span>Library <span className="font-bold" style={{ color: gold }}>+</span> Downloads
//         </h2>
//       </motion.div>

//       {/* Material Cards Container (UPDATED GRID TO 3 COLUMNS) */}
//       <motion.div
...
      <div className="max-w-7xl mx-auto relative flex items-center justify-center">
        ...
        {/* --- Previous Button (Placed outside the content area) --- */}
        <motion.button
          onClick={() => paginate(-1)}
          className="absolute left-[-60px] -mt-20 z-20 p-3 rounded-full shadow-lg hidden lg:block" // Adjusted left position
          style={{ backgroundColor: gold, color: darkGreen }}
...
        <div className="relative overflow-hidden w-full min-h-[500px]"> {/* Set min-height to prevent collapse */}
...
                  className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 w-full"
                    // Add absolute positioning when exiting, but relative when centered (handled by variants now)
                  custom={direction}
...
        {/* --- Next Button (Placed outside the content area) --- */}
        <motion.button
          onClick={() => paginate(1)}
          className="absolute right-[-60px] -mt-20 z-20 p-3 rounded-full shadow-lg hidden lg:block"
          style={{ backgroundColor: gold, color: darkGreen }}
          whileHover={{ scale: 1.1 }}
          whileTap={{ scale: 0.9 }}
        >
