      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative overflow-hidden">
          <motion.div
            ...
            // Mobile: 1 item visible -> 10 * 100% = 1000%
            // Tablet: 2 items visible -> 10 * 50% = 500%
            // Desktop: 3 items visible -> 10 * 33.33% = 333.33%
          ...
          >
            {extendedTestimonials.map((testimonial, index) => (
              <motion.div
                ...
                // FIX: Used 'animate' instead of 'whileInView' to ensure immediate load
        ...
        <AnimatePresence>
          {selectedId && selectedTestimonial && (
            <motion.div 
              // Removed layoutId to fix layout glitch
