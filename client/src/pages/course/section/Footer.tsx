    ...
    >
      <div className="max-w-7xl mx-auto">
          ...
          <div>
            ...
            <form className="flex flex-col gap-3">
              <input 
                ...
                className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/20 focus:outline-none focus:border-[#B99A49] text-white placeholder-white/50"
              />
              <button 
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs opacity-60">
          ...
          <p>© 2025 Greens Technology. All rights reserved.</p>
