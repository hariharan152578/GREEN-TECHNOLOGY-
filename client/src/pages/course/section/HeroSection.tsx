...
// If you are using 'logo' locally, ensure it is imported correctly.
...
const stackVariants: Variants = { // Applied : Variants
  hidden: { opacity: 0 },
  visible: {
    opacity: 1,
    transition: {
...
const itemVariants: Variants = { // Applied : Variants
...
                initial={{ y: 100 }}
                animate={{ y: 0 }}
                transition={{ delay: 0.4, duration: 0.8 /* FIX: Removed , ease: "easeOut" */ }}
                >
                Greens Technology
                </motion.h1>
            </div>
...
const modalVariants: Variants = { // Applied : Variants
    hidden: { opacity: 0 },
    visible: { opacity: 1 },
};

const formVariants: Variants = { // Applied : Variants
